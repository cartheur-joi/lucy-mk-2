...
- Preview image: [`example-assembly.png`](example-assembly.png)
- FreeCAD document: [`example-assembly.FCStd`](example-assembly.FCStd)
- Exchange model: [`example-assembly.step`](example-assembly.step)
